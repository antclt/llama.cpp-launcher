...
impl Key {
    ...
    (Key::ErrRpcFileNotFound, &Language::En) => "ggml-rpc-server file not found",
            ...
            (Key::HelpReasoningEffort, &Language::Zh) => "传递给对话模板的推理强度等级，如 minimal/low/medium/high/xhigh/max",
            (Key::HelpReasoningEffort, &Language::En) => "Reasoning effort level passed to the chat template (minimal/low/medium/high/xhigh/max)",
